...
- generated_at: 2026-08-17T13:50:33.027957+00:00
...
## 1. Hygiene 門檻特徵(各層皆備)
| feature | class | T0% | T1% | T2% | T3% | gap | gap 95%CI | ρ(log★) | F0復現 | mkt? | 強度 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| skill_spec_compliant | hygiene | 100.0 | 100.0 | 100.0 | 100.0 | 0.0 | [0.0, 0.0] | None | ✘ |  | strong |
| dir_scripts | hygiene | 71.4 | 87.5 | 84.8 | 83.3 | 11.9 | [-35.7, 57.1] | 0.002 | ✔ |  | strong |

## 2. Tier 梯度特徵(differentiator,依 gap 排序)
| feature | class | T0% | T1% | T2% | T3% | gap | gap 95%CI | ρ(log★) | F0復現 | mkt? | 強度 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| has_marketplace_json | differentiator | 28.6 | 62.5 | 60.6 | 100.0 | 71.4 | [42.9, 100.0] | 0.321 | ✔ | ⚠ | moderate |
| dir_examples | differentiator | 14.3 | 25.0 | 33.3 | 66.7 | 52.4 | [4.8, 100.0] | 0.197 | ✔ |  | moderate |
| install_oneliner_in_readme | differentiator | 57.1 | 62.5 | 78.8 | 100.0 | 42.9 | [14.3, 85.7] | 0.321 | ✔ |  | strong |
| has_tests_or_evals | differentiator | 28.6 | 50.0 | 69.7 | 66.7 | 38.1 | [-11.9, 85.7] | 0.213 | ✔ |  | strong |
| readme_has_before_after | differentiator | 28.6 | 50.0 | 45.5 | 66.7 | 38.1 | [-11.9, 85.7] | 0.192 | ✔ | ⚠ | moderate |
