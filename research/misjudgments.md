...
**目前 2 條(批次 4 終審蓄積)。** 第四批(2026-09-03,fresh 波 6 條)已清空——六條全動手(rubric 3.6.0 / 工具 2.3.7),含逐案 verdict 穩定性驗算與一次修法自查;全文 [`misjudgment-batch-2026-09-03.md`](misjudgment-batch-2026-09-03.md)。 第三次批次(2026-09-02,15 條)已清空——15 條全數處置(12 全動手、3 部分動手;rubric 3.4.0 / 工具 2.3.3);查證、逐條處置與負向驗證輸出見
...
| 日期 | 對象 | 規則 | 它說什麼 | 我認為應該是什麼 |
|------|------|------|----------|------------------|
| 2026-09-03 | 終審 F7 | craft_value_mapping 集合聚合「風格臂」 | 單樣本 mixed 依傷及性分傷及/風格兩臂 | **風格臂近乎死碼**——位置規則已在樣本層把不傷及的降回 findings,能到 mixed 的瑕疵幾乎必為傷及性;「基礎部分達成」型 mixed 又無離散瑕疵可跑測試。該臂要嘛刪、要嘛明示它服務哪種真實形態 |
| 2026-09-03 | 終審 F8 | collection_aggregation #2 與聚合 poor 句 | 有表面樣本 good/mixed 二值 | **與「大量宣稱幾乎無機制→poor」句之間無邊界**(單一序5-實質樣本聚合取何值未言明);#3 對 any-poor 封頂顯式註明刻意、#2 沒有,expressio unius 誘發跨條反推。需一句邊界 |
