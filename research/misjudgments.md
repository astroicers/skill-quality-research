...
**目前 0 條。** 第四批(2026-09-03,fresh 波 6 條)已清空——六條全動手(rubric 3.6.0 / 工具 2.3.7),含逐案 verdict 穩定性驗算與一次修法自查;全文 [`misjudgment-batch-2026-09-03.md`](misjudgment-batch-2026-09-03.md)。 第三次批次(2026-09-02,15 條)已清空——15 條全數處置(12 全動手、3 部分動手;rubric 3.4.0 / 工具 2.3.3);查證、逐條處置與負向驗證輸出見
